...
import { renderAcppRegistry } from "./views/acpp-registry.ts";
    ...
    <div class="shell ${isChat ? "shell--chat" : ""} ${chatFocus ? "shell--chat-focus" : ""} ${state.settings.navCollapsed ? "shell--nav-collapsed" : ""} ${state.onboarding ? "shell--onboarding" : ""}">
        ...
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src=${basePath ? `${basePath}/brand-logo.png` : "/brand-logo.png"} alt="deOpenClaw" />
            </div>
            <div class="brand-text">
              <div class="brand-title">deOPENCLAW</div>
      ...
      <main class="content ${isChat ? "content--chat" : ""}">
        ...
        ${
          state.tab === "registry"
            ? renderAcppRegistry({
                loading: state.acppRegistryLoading,
                error: state.acppRegistryError,
                agents: state.acppRegistryAgents,
                selectedAgentId: state.acppRegistrySelected,
                detail: state.acppRegistryDetail,
                detailLoading: state.acppRegistryDetailLoading,
                health: state.acppRegistryHealth,
